...
# 1300+ tickers hardcoded to avoid misclassification from keyword heuristics.
TICKER_SECTOR_OVERRIDE = {
    # hyperscaler
    'AAPL': 'hyperscaler', 'ADI': 'hyperscaler', 'AMAT': 'hyperscaler', 'AMD': 'hyperscaler', 'AMZN': 'hyperscaler', 'ASML': 'hyperscaler',
    'AVGO': 'hyperscaler', 'CDNS': 'hyperscaler', 'CSCO': 'hyperscaler', 'GOOG': 'hyperscaler', 'GOOGL': 'hyperscaler', 'INTC': 'hyperscaler',
    'KLAC': 'hyperscaler', 'LRCX': 'hyperscaler', 'MCHP': 'hyperscaler', 'META': 'hyperscaler', 'MRVL': 'hyperscaler', 'MSFT': 'hyperscaler',
    'MU': 'hyperscaler', 'NFLX': 'hyperscaler', 'NVDA': 'hyperscaler', 'NXPI': 'hyperscaler', 'ON': 'hyperscaler', 'ORCL': 'hyperscaler',
    'QCOM': 'hyperscaler', 'QRVO': 'hyperscaler', 'SNPS': 'hyperscaler', 'SWKS': 'hyperscaler', 'TSM': 'hyperscaler', 'TXN': 'hyperscaler',
    # saas_tech
    'ABNB': 'saas_tech', 'ADBE': 'saas_tech', 'AI': 'saas_tech', 'AKAM': 'saas_tech', 'ALRM': 'saas_tech', 'ALTR': 'saas_tech',
    'ANET': 'saas_tech', 'ANSS': 'saas_tech', 'APP': 'saas_tech', 'APPF': 'saas_tech', 'ARM': 'saas_tech', 'ASAN': 'saas_tech',
    'AZPN': 'saas_tech', 'BABA': 'saas_tech', 'BBAI': 'saas_tech', 'BIDU': 'saas_tech', 'BILI': 'saas_tech', 'BILL': 'saas_tech',
    'BOX': 'saas_tech', 'BRZE': 'saas_tech', 'BSY': 'saas_tech', 'CARG': 'saas_tech', 'CFLT': 'saas_tech', 'CHDN': 'saas_tech',
    'CHGG': 'saas_tech', 'CIEN': 'saas_tech', 'CIFR': 'saas_tech', 'CLSK': 'saas_tech', 'COMP': 'saas_tech', 'COUR': 'saas_tech',
    'CRM': 'saas_tech', 'CRSR': 'saas_tech', 'CRWD': 'saas_tech', 'CVNA': 'saas_tech', 'CWAN': 'saas_tech', 'CYBR': 'saas_tech',
    'DASH': 'saas_tech', 'DBX': 'saas_tech', 'DDOG': 'saas_tech', 'DELL': 'saas_tech', 'DKNG': 'saas_tech', 'DM': 'saas_tech',
    'DOCU': 'saas_tech', 'DT': 'saas_tech', 'DUOL': 'saas_tech', 'ESTC': 'saas_tech', 'EVBG': 'saas_tech', 'FFIV': 'saas_tech',
    'FICO': 'saas_tech', 'FROG': 'saas_tech', 'FRSH': 'saas_tech', 'FSLY': 'saas_tech', 'FTNT': 'saas_tech', 'GDDY': 'saas_tech',
    'GEN': 'saas_tech', 'GENI': 'saas_tech', 'GRAB': 'saas_tech', 'GTLB': 'saas_tech', 'HEAR': 'saas_tech', 'HPE': 'saas_tech',
    'HPQ': 'saas_tech', 'HUBS': 'saas_tech', 'IBM': 'saas_tech', 'INTU': 'saas_tech', 'IOT': 'saas_tech', 'IQ': 'saas_tech',
    'IREN': 'saas_tech', 'JAMF': 'saas_tech', 'JD': 'saas_tech', 'JNPR': 'saas_tech', 'LI': 'saas_tech', 'LLNW': 'saas_tech',
    'LOGI': 'saas_tech', 'LOPE': 'saas_tech', 'LYFT': 'saas_tech', 'MARA': 'saas_tech', 'MDB': 'saas_tech', 'MKFG': 'saas_tech',
    'MNDY': 'saas_tech', 'MTTR': 'saas_tech', 'NCNO': 'saas_tech', 'NET': 'saas_tech', 'NEWR': 'saas_tech', 'NIO': 'saas_tech',
    'NOW': 'saas_tech', 'NTAP': 'saas_tech', 'NTES': 'saas_tech', 'OKTA': 'saas_tech', 'OPEN': 'saas_tech', 'PANW': 'saas_tech',
    'PATH': 'saas_tech', 'PAYC': 'saas_tech', 'PCTY': 'saas_tech', 'PDD': 'saas_tech', 'PENN': 'saas_tech', 'PINS': 'saas_tech',
    'PRNT': 'saas_tech', 'PSTG': 'saas_tech', 'PTC': 'saas_tech', 'QLYS': 'saas_tech', 'QTWO': 'saas_tech', 'RBLX': 'saas_tech',
    'RDFN': 'saas_tech', 'RIOT': 'saas_tech', 'ROKU': 'saas_tech', 'RPD': 'saas_tech', 'RSI': 'saas_tech', 'S': 'saas_tech',
    'SAIL': 'saas_tech', 'SE': 'saas_tech', 'SEMR': 'saas_tech', 'SHOP': 'saas_tech', 'SMAR': 'saas_tech', 'SMCI': 'saas_tech',
    'SNAP': 'saas_tech', 'SNOW': 'saas_tech', 'SOUN': 'saas_tech', 'SPLK': 'saas_tech', 'SPOT': 'saas_tech', 'SQSP': 'saas_tech',
    'STRA': 'saas_tech', 'SUMO': 'saas_tech', 'SWI': 'saas_tech', 'TCOM': 'saas_tech', 'TEAM': 'saas_tech', 'TENB': 'saas_tech',
    'TME': 'saas_tech', 'TTD': 'saas_tech', 'TWLO': 'saas_tech', 'TWOU': 'saas_tech', 'U': 'saas_tech', 'UBER': 'saas_tech',
    'VEEV': 'saas_tech', 'VIEW': 'saas_tech', 'VRM': 'saas_tech', 'VRNS': 'saas_tech', 'WB': 'saas_tech', 'WDAY': 'saas_tech',
    'WEBL': 'saas_tech', 'WIX': 'saas_tech', 'XPEV': 'saas_tech', 'Z': 'saas_tech', 'ZG': 'saas_tech', 'ZI': 'saas_tech',
    'ZM': 'saas_tech', 'ZS': 'saas_tech', 'ZTO': 'saas_tech',
    # data_analytics
    'ADP': 'data_analytics', 'BR': 'data_analytics', 'CBOE': 'data_analytics', 'CCEP': 'data_analytics', 'CME': 'data_analytics', 'DAVA': 'data_analytics',
    'DNB': 'data_analytics', 'ENV': 'data_analytics', 'EVR': 'data_analytics', 'FDS': 'data_analytics', 'FI': 'data_analytics', 'FIS': 'data_analytics',
    'FISV': 'data_analytics', 'GPN': 'data_analytics', 'GWRE': 'data_analytics', 'HLI': 'data_analytics', 'ICE': 'data_analytics', 'INST': 'data_analytics',
    'LAZ': 'data_analytics', 'LSEG': 'data_analytics', 'MC': 'data_analytics', 'MCO': 'data_analytics', 'MKTX': 'data_analytics', 'MSCI': 'data_analytics',
    'NDAQ': 'data_analytics', 'PAYX': 'data_analytics', 'PIPR': 'data_analytics', 'PJT': 'data_analytics', 'PLTR': 'data_analytics', 'PRGS': 'data_analytics',
    'SNEX': 'data_analytics', 'SPGI': 'data_analytics', 'SPNS': 'data_analytics', 'TRI': 'data_analytics', 'TYL': 'data_analytics', 'VIRT': 'data_analytics',
    'VRSK': 'data_analytics', 'WEX': 'data_analytics',
    # payment_network
    'AXP': 'payment_network', 'DFS': 'payment_network', 'MA': 'payment_network', 'V': 'payment_network',
    # fintech
    'ADYEN': 'fintech', 'AFRM': 'fintech', 'CLOV': 'fintech', 'COIN': 'fintech', 'DAVE': 'fintech', 'FLYW': 'fintech',
    'FOUR': 'fintech', 'FUTU': 'fintech', 'HIPO': 'fintech', 'HOOD': 'fintech', 'LC': 'fintech', 'LMND': 'fintech',
    'MARQETA': 'fintech', 'MELI': 'fintech', 'MQ': 'fintech', 'NU': 'fintech', 'OLO': 'fintech', 'OSCR': 'fintech',
    'PAGS': 'fintech', 'PAYO': 'fintech', 'PSFE': 'fintech', 'PYPL': 'fintech', 'RELY': 'fintech', 'ROOT': 'fintech',
    'RPAY': 'fintech', 'SEZL': 'fintech', 'SOFI': 'fintech', 'SQ': 'fintech', 'STNE': 'fintech', 'TIGR': 'fintech',
    'TOST': 'fintech', 'UPST': 'fintech', 'VNET': 'fintech', 'XP': 'fintech',
    # bank
    'AB': 'bank', 'ABCB': 'bank', 'ALLY': 'bank', 'AMG': 'bank', 'AMP': 'bank', 'AMSF': 'bank',
    'APO': 'bank', 'ARES': 'bank', 'BAC': 'bank', 'BAM': 'bank', 'BANR': 'bank', 'BEN': 'bank',
    'BHLB': 'bank', 'BK': 'bank', 'BN': 'bank', 'BOKF': 'bank', 'BRKL': 'bank', 'BX': 'bank',
    'BY': 'bank', 'C': 'bank', 'CADE': 'bank', 'CBU': 'bank', 'CFG': 'bank', 'CG': 'bank',
    'CMA': 'bank', 'CNS': 'bank', 'COF': 'bank', 'COLB': 'bank', 'CUBI': 'bank', 'DCOM': 'bank',
    'EFSC': 'bank', 'EV': 'bank', 'EWBC': 'bank', 'FBK': 'bank', 'FCNCA': 'bank', 'FFBC': 'bank',
    'FFIN': 'bank', 'FHN': 'bank', 'FITB': 'bank', 'FNB': 'bank', 'FULT': 'bank', 'GBCI': 'bank',
    'GS': 'bank', 'HBAN': 'bank', 'HBT': 'bank', 'HOPE': 'bank', 'HWC': 'bank', 'IBKR': 'bank',
    'IBOC': 'bank', 'IBTX': 'bank', 'INDB': 'bank', 'IVZ': 'bank', 'JPM': 'bank', 'KEY': 'bank',
    'KKR': 'bank', 'LPLA': 'bank', 'MCB': 'bank', 'MS': 'bank', 'MTB': 'bank', 'NTRS': 'bank',
    'NWBI': 'bank', 'NYCB': 'bank', 'ONB': 'bank', 'OWL': 'bank', 'OZK': 'bank', 'PACW': 'bank',
    'PFBC': 'bank', 'PNC': 'bank', 'PNFP': 'bank', 'PPBI': 'bank', 'RF': 'bank', 'RJF': 'bank',
    'RNST': 'bank', 'SBCF': 'bank', 'SBSI': 'bank', 'SCHW': 'bank', 'SFBS': 'bank', 'SFNC': 'bank',
    'SNV': 'bank', 'SSB': 'bank', 'STT': 'bank', 'SYF': 'bank', 'TCBI': 'bank', 'TFC': 'bank',
    'TOWN': 'bank', 'TRMK': 'bank', 'TROW': 'bank', 'UBSI': 'bank', 'UMBF': 'bank', 'USB': 'bank',
    'VCTR': 'bank', 'VLY': 'bank', 'WAFD': 'bank', 'WAL': 'bank', 'WDR': 'bank', 'WFC': 'bank',
    'WSFS': 'bank', 'WTFC': 'bank', 'ZION': 'bank',
    # specialty_lender
    'ABR': 'specialty_lender', 'ACRE': 'specialty_lender', 'ADC': 'specialty_lender', 'AGNC': 'specialty_lender', 'AMH': 'specialty_lender', 'AMT': 'specialty_lender',
    'ARE': 'specialty_lender', 'ARI': 'specialty_lender', 'AVB': 'specialty_lender', 'BRSP': 'specialty_lender', 'BXMT': 'specialty_lender', 'BXP': 'specialty_lender',
    'COLD': 'specialty_lender', 'COR': 'specialty_lender', 'CPT': 'specialty_lender', 'CUBE': 'specialty_lender', 'DLR': 'specialty_lender', 'DOC': 'specialty_lender',
    'DRH': 'specialty_lender', 'EFC': 'specialty_lender', 'ELS': 'specialty_lender', 'EPRT': 'specialty_lender', 'EQIX': 'specialty_lender', 'EQR': 'specialty_lender',
    'ESS': 'specialty_lender', 'FCPT': 'specialty_lender', 'FR': 'specialty_lender', 'FRT': 'specialty_lender', 'GLPI': 'specialty_lender', 'GPMT': 'specialty_lender',
    'HR': 'specialty_lender', 'HST': 'specialty_lender', 'INVH': 'specialty_lender', 'IRM': 'specialty_lender', 'KIM': 'specialty_lender', 'KREF': 'specialty_lender',
    'LADR': 'specialty_lender', 'LAMR': 'specialty_lender', 'LSI': 'specialty_lender', 'MAA': 'specialty_lender', 'MFA': 'specialty_lender', 'MPW': 'specialty_lender',
    'NLY': 'specialty_lender', 'NNN': 'specialty_lender', 'NSA': 'specialty_lender', 'NYMT': 'specialty_lender', 'O': 'specialty_lender', 'OHI': 'specialty_lender',
    'OUT': 'specialty_lender', 'PEAK': 'specialty_lender', 'PK': 'specialty_lender', 'PLD': 'specialty_lender', 'PMT': 'specialty_lender', 'PSA': 'specialty_lender',
    'RC': 'specialty_lender', 'REG': 'specialty_lender', 'REXR': 'specialty_lender', 'RHP': 'specialty_lender', 'RWT': 'specialty_lender', 'SBRA': 'specialty_lender',
    'SEVN': 'specialty_lender', 'SHO': 'specialty_lender', 'SLG': 'specialty_lender', 'SPG': 'specialty_lender', 'STAG': 'specialty_lender', 'STOR': 'specialty_lender',
    'STWD': 'specialty_lender', 'SUI': 'specialty_lender', 'TPVG': 'specialty_lender', 'TRNO': 'specialty_lender', 'TRTX': 'specialty_lender', 'TWO': 'specialty_lender',
    'UDR': 'specialty_lender', 'VICI': 'specialty_lender', 'VNO': 'specialty_lender', 'VTR': 'specialty_lender', 'WELL': 'specialty_lender', 'WPC': 'specialty_lender',
    'XHR': 'specialty_lender',
    # insurance
    'ACGL': 'insurance', 'AFG': 'insurance', 'AFL': 'insurance', 'AIG': 'insurance', 'AJG': 'insurance', 'ALL': 'insurance',
    'AON': 'insurance', 'BRK-A': 'insurance', 'BRK-B': 'insurance', 'BRO': 'insurance', 'CB': 'insurance', 'CI': 'insurance',
    'CINF': 'insurance', 'CNA': 'insurance', 'CNC': 'insurance', 'EG': 'insurance', 'ELV': 'insurance', 'ERIE': 'insurance',
    'FAF': 'insurance', 'FNF': 'insurance', 'GL': 'insurance', 'HCI': 'insurance', 'HIG': 'insurance', 'HUM': 'insurance',
    'KMPR': 'insurance', 'KNSL': 'insurance', 'L': 'insurance', 'LNC': 'insurance', 'MET': 'insurance', 'MMC': 'insurance',
    'MOH': 'insurance', 'ORI': 'insurance', 'PGR': 'insurance', 'PLMR': 'insurance', 'PRU': 'insurance', 'RE': 'insurance',
    'RLI': 'insurance', 'RNR': 'insurance', 'RYAN': 'insurance', 'SIGI': 'insurance', 'STC': 'insurance', 'THG': 'insurance',
    'TRV': 'insurance', 'UFCS': 'insurance', 'UNH': 'insurance', 'UNM': 'insurance', 'WRB': 'insurance', 'WTW': 'insurance',
    # pharma
    'A': 'pharma', 'ABBV': 'pharma', 'ABT': 'pharma', 'ACHC': 'pharma', 'ALGN': 'pharma', 'ALNY': 'pharma',
    'AMED': 'pharma', 'AMGN': 'pharma', 'ARGX': 'pharma', 'ATRC': 'pharma', 'AXNX': 'pharma', 'AZN': 'pharma',
    'BDX': 'pharma', 'BEAM': 'pharma', 'BIIB': 'pharma', 'BIO': 'pharma', 'BMRN': 'pharma', 'BMY': 'pharma',
    'BSX': 'pharma', 'CERN': 'pharma', 'CNMD': 'pharma', 'CPRX': 'pharma', 'CRL': 'pharma', 'CRSP': 'pharma',
    'CTLT': 'pharma', 'DHR': 'pharma', 'DOCS': 'pharma', 'DXCM': 'pharma', 'EDIT': 'pharma', 'ELAN': 'pharma',
    'ENSG': 'pharma', 'EW': 'pharma', 'EXEL': 'pharma', 'GDRX': 'pharma', 'GEHC': 'pharma', 'GH': 'pharma',
    'GILD': 'pharma', 'GKOS': 'pharma', 'GMED': 'pharma', 'GSK': 'pharma', 'HALO': 'pharma', 'HIMS': 'pharma',
    'HOLX': 'pharma', 'HSIC': 'pharma', 'HZNP': 'pharma', 'IART': 'pharma', 'IDEXX': 'pharma', 'IDXX': 'pharma',
    'ILMN': 'pharma', 'INCY': 'pharma', 'IONS': 'pharma', 'IQV': 'pharma', 'IRTC': 'pharma', 'ISRG': 'pharma',
    'JAZZ': 'pharma', 'JNJ': 'pharma', 'LEGN': 'pharma', 'LIVN': 'pharma', 'LLY': 'pharma', 'LUNG': 'pharma',
    'MASI': 'pharma', 'MDT': 'pharma', 'MEDP': 'pharma', 'MMSI': 'pharma', 'MRK': 'pharma', 'MRNA': 'pharma',
    'MTD': 'pharma', 'NBIX': 'pharma', 'NEO': 'pharma', 'NTLA': 'pharma', 'NTRA': 'pharma', 'NUVA': 'pharma',
    'NVCR': 'pharma', 'NVO': 'pharma', 'NVS': 'pharma', 'OMCL': 'pharma', 'PCVX': 'pharma', 'PDCO': 'pharma',
    'PFE': 'pharma', 'PKI': 'pharma', 'PODD': 'pharma', 'PRME': 'pharma', 'RARE': 'pharma', 'RCKT': 'pharma',
    'REGN': 'pharma', 'RGEN': 'pharma', 'RPRX': 'pharma', 'RVTY': 'pharma', 'SGEN': 'pharma', 'SNY': 'pharma',
    'SRPT': 'pharma', 'SWAV': 'pharma', 'SYK': 'pharma', 'SYNH': 'pharma', 'TECH': 'pharma', 'TFX': 'pharma',
    'TMO': 'pharma', 'TNDM': 'pharma', 'UTHR': 'pharma', 'VERV': 'pharma', 'VRTX': 'pharma', 'VTRS': 'pharma',
    'WAT': 'pharma', 'WST': 'pharma', 'XRAY': 'pharma', 'ZTS': 'pharma',
    # consumer
    'AAP': 'consumer', 'ABG': 'consumer', 'ACI': 'consumer', 'AEO': 'consumer', 'AN': 'consumer', 'ANF': 'consumer',
    'ARCO': 'consumer', 'ARHS': 'consumer', 'ARKO': 'consumer', 'AZO': 'consumer', 'BBWI': 'consumer', 'BBY': 'consumer',
    'BC': 'consumer', 'BF-B': 'consumer', 'BGS': 'consumer', 'BIG': 'consumer', 'BIRK': 'consumer', 'BJ': 'consumer',
    'BJRI': 'consumer', 'BKNG': 'consumer', 'BOOT': 'consumer', 'BOWL': 'consumer', 'BRFS': 'consumer', 'BROS': 'consumer',
    'BTI': 'consumer', 'BURL': 'consumer', 'BYD': 'consumer', 'BYND': 'consumer', 'CAG': 'consumer', 'CAKE': 'consumer',
    'CAL': 'consumer', 'CASY': 'consumer', 'CATO': 'consumer', 'CAVA': 'consumer', 'CCL': 'consumer', 'CELH': 'consumer',
    'CHD': 'consumer', 'CHWY': 'consumer', 'CL': 'consumer', 'CLX': 'consumer', 'CMG': 'consumer', 'COLM': 'consumer',
    'COST': 'consumer', 'COTY': 'consumer', 'CPB': 'consumer', 'CPRI': 'consumer', 'CRBG': 'consumer', 'CROX': 'consumer',
    'CVS': 'consumer', 'CWH': 'consumer', 'CZR': 'consumer', 'DBI': 'consumer', 'DECK': 'consumer', 'DENN': 'consumer',
    'DEO': 'consumer', 'DESP': 'consumer', 'DG': 'consumer', 'DIS': 'consumer', 'DLTR': 'consumer', 'DORM': 'consumer',
    'DPZ': 'consumer', 'DRI': 'consumer', 'EAT': 'consumer', 'EDR': 'consumer', 'EL': 'consumer', 'ETSY': 'consumer',
    'EXPE': 'consumer', 'EXPR': 'consumer', 'F': 'consumer', 'FIGS': 'consumer', 'FIVE': 'consumer', 'FIZZ': 'consumer',
    'FLOR': 'consumer', 'FND': 'consumer', 'FOXF': 'consumer', 'FRPT': 'consumer', 'FTCH': 'consumer', 'FUN': 'consumer',
    'GCO': 'consumer', 'GIII': 'consumer', 'GIS': 'consumer', 'GM': 'consumer', 'GPC': 'consumer', 'GPI': 'consumer',
    'GPS': 'consumer', 'H': 'consumer', 'HAIN': 'consumer', 'HBI': 'consumer', 'HD': 'consumer', 'HELE': 'consumer',
    'HLT': 'consumer', 'HMC': 'consumer', 'HOG': 'consumer', 'HRL': 'consumer', 'HSY': 'consumer', 'IHG': 'consumer',
    'IHRT': 'consumer', 'IPAR': 'consumer', 'JACK': 'consumer', 'JJSF': 'consumer', 'K': 'consumer', 'KDP': 'consumer',
    'KMB': 'consumer', 'KMX': 'consumer', 'KO': 'consumer', 'KR': 'consumer', 'LAD': 'consumer', 'LANC': 'consumer',
    'LCID': 'consumer', 'LCII': 'consumer', 'LL': 'consumer', 'LNTH': 'consumer', 'LOCO': 'consumer', 'LOVE': 'consumer',
    'LOW': 'consumer', 'LULU': 'consumer', 'LVS': 'consumer', 'LW': 'consumer', 'LYV': 'consumer', 'MAR': 'consumer',
    'MCD': 'consumer', 'MDLZ': 'consumer', 'MGM': 'consumer', 'MLCO': 'consumer', 'MMYT': 'consumer', 'MNRO': 'consumer',
    'MNST': 'consumer', 'MO': 'consumer', 'MOD': 'consumer', 'MTN': 'consumer', 'MUSA': 'consumer', 'NCLH': 'consumer',
    'NDLS': 'consumer', 'NKE': 'consumer', 'OLLI': 'consumer', 'ONON': 'consumer', 'ORLY': 'consumer', 'OXM': 'consumer',
    'PAG': 'consumer', 'PATK': 'consumer', 'PEP': 'consumer', 'PG': 'consumer', 'PII': 'consumer', 'PLAY': 'consumer',
    'PLCE': 'consumer', 'PM': 'consumer', 'POSH': 'consumer', 'POST': 'consumer', 'PPC': 'consumer', 'PRPL': 'consumer',
    'PRTS': 'consumer', 'PSMT': 'consumer', 'PTLO': 'consumer', 'PVH': 'consumer', 'PZZA': 'consumer', 'QSR': 'consumer',
    'RACE': 'consumer', 'RCL': 'consumer', 'REAL': 'consumer', 'RENT': 'consumer', 'RH': 'consumer', 'RIVN': 'consumer',
    'RL': 'consumer', 'ROST': 'consumer', 'RRGB': 'consumer', 'RUTH': 'consumer', 'RVLV': 'consumer', 'SAFM': 'consumer',
    'SAH': 'consumer', 'SAM': 'consumer', 'SBUX': 'consumer', 'SCVL': 'consumer', 'SEAS': 'consumer', 'SFD': 'consumer',
    'SFM': 'consumer', 'SG': 'consumer', 'SHAK': 'consumer', 'SIX': 'consumer', 'SJM': 'consumer', 'SKIN': 'consumer',
    'SKX': 'consumer', 'SMPL': 'consumer', 'SNBR': 'consumer', 'STLA': 'consumer', 'STZ': 'consumer', 'TACO': 'consumer',
    'TAP': 'consumer', 'TGT': 'consumer', 'THO': 'consumer', 'THS': 'consumer', 'TILE': 'consumer', 'TJX': 'consumer',
    'TKO': 'consumer', 'TM': 'consumer', 'TPB': 'consumer', 'TPR': 'consumer', 'TRIP': 'consumer', 'TRUP': 'consumer',
    'TSCO': 'consumer', 'TSLA': 'consumer', 'TSN': 'consumer', 'TXRH': 'consumer', 'UA': 'consumer', 'UAA': 'consumer',
    'ULTA': 'consumer', 'URBN': 'consumer', 'VFC': 'consumer', 'VSCO': 'consumer', 'W': 'consumer', 'WBA': 'consumer',
    'WGO': 'consumer', 'WH': 'consumer', 'WING': 'consumer', 'WMT': 'consumer', 'WOOF': 'consumer', 'WRBY': 'consumer',
    'WSM': 'consumer', 'WWW': 'consumer', 'WYNN': 'consumer', 'XPOF': 'consumer', 'YETI': 'consumer', 'YUM': 'consumer',
    # industrial
    'AA': 'industrial', 'AAL': 'industrial', 'ACM': 'industrial', 'AEM': 'industrial', 'AGCO': 'industrial', 'AGI': 'industrial',
    'ALB': 'industrial', 'ALK': 'industrial', 'ALLE': 'industrial', 'AMCR': 'industrial', 'AME': 'industrial', 'APD': 'industrial',
    'ARNC': 'industrial', 'ASGN': 'industrial', 'ATI': 'industrial', 'ATKR': 'industrial', 'ATR': 'industrial', 'AWI': 'industrial',
    'AYI': 'industrial', 'AZEK': 'industrial', 'BECN': 'industrial', 'BERY': 'industrial', 'BLD': 'industrial', 'BLDR': 'industrial',
    'BLL': 'industrial', 'CARR': 'industrial', 'CAT': 'industrial', 'CC': 'industrial', 'CCK': 'industrial', 'CE': 'industrial',
    'CENX': 'industrial', 'CF': 'industrial', 'CHRW': 'industrial', 'CLF': 'industrial', 'CLH': 'industrial', 'CMI': 'industrial',
    'CNHI': 'industrial', 'CNI': 'industrial', 'CP': 'industrial', 'CRS': 'industrial', 'CSWI': 'industrial', 'CSX': 'industrial',
    'CTVA': 'industrial', 'CWST': 'industrial', 'CX': 'industrial', 'DAC': 'industrial', 'DAL': 'industrial', 'DD': 'industrial',
    'DE': 'industrial', 'DOOR': 'industrial', 'DOV': 'industrial', 'DOW': 'industrial', 'DSGR': 'industrial', 'DY': 'industrial',
    'EAGLE': 'industrial', 'ECL': 'industrial', 'ECOL': 'industrial', 'EMN': 'industrial', 'EMR': 'industrial', 'ENTG': 'industrial',
    'ESGC': 'industrial', 'ETN': 'industrial', 'EXP': 'industrial', 'EXPD': 'industrial', 'FAST': 'industrial', 'FBHS': 'industrial',
    'FBIN': 'industrial', 'FCX': 'industrial', 'FDX': 'industrial', 'FERG': 'industrial', 'FIX': 'industrial', 'FMC': 'industrial',
    'FNV': 'industrial', 'FSS': 'industrial', 'FWRD': 'industrial', 'GE': 'industrial', 'GEV': 'industrial', 'GFL': 'industrial',
    'GGG': 'industrial', 'GMS': 'industrial', 'GNRC': 'industrial', 'GOGL': 'industrial', 'GOLD': 'industrial', 'GPK': 'industrial',
    'GRMN': 'industrial', 'GTLS': 'industrial', 'GWW': 'industrial', 'GXO': 'industrial', 'HA': 'industrial', 'HAYN': 'industrial',
    'HDS': 'industrial', 'HEES': 'industrial', 'HON': 'industrial', 'HTLD': 'industrial', 'HUBB': 'industrial', 'HUN': 'industrial',
    'IBP': 'industrial', 'IEX': 'industrial', 'IFF': 'industrial', 'INSW': 'industrial', 'IP': 'industrial', 'IR': 'industrial',
    'ITE': 'industrial', 'ITW': 'industrial', 'J': 'industrial', 'JBHT': 'industrial', 'JBLU': 'industrial', 'JCI': 'industrial',
    'JELD': 'industrial', 'KALU': 'industrial', 'KBR': 'industrial', 'KELYA': 'industrial', 'KEX': 'industrial', 'KGC': 'industrial',
    'KNX': 'industrial', 'KTOS': 'industrial', 'LAC': 'industrial', 'LIN': 'industrial', 'LPX': 'industrial', 'LTHM': 'industrial',
    'LUV': 'industrial', 'LYB': 'industrial', 'MAN': 'industrial', 'MAS': 'industrial', 'MATX': 'industrial', 'MFGP': 'industrial',
    'MKSI': 'industrial', 'MLM': 'industrial', 'MMM': 'industrial', 'MOS': 'industrial', 'MP': 'industrial', 'MSM': 'industrial',
    'MTZ': 'industrial', 'NDSN': 'industrial', 'NEM': 'industrial', 'NSC': 'industrial', 'NTR': 'industrial', 'NUE': 'industrial',
    'OC': 'industrial', 'ODFL': 'industrial', 'OLD': 'industrial', 'OLN': 'industrial', 'OSK': 'industrial', 'OTIS': 'industrial',
    'PCAR': 'industrial', 'PH': 'industrial', 'PKG': 'industrial', 'PLL': 'industrial', 'POOL': 'industrial', 'PPG': 'industrial',
    'PRIM': 'industrial', 'PWR': 'industrial', 'RGLD': 'industrial', 'RHI': 'industrial', 'ROCK': 'industrial', 'ROK': 'industrial',
    'ROP': 'industrial', 'RS': 'industrial', 'RSG': 'industrial', 'RXO': 'industrial', 'SAIA': 'industrial', 'SAVE': 'industrial',
    'SCCO': 'industrial', 'SEE': 'industrial', 'SHW': 'industrial', 'SITE': 'industrial', 'SLGN': 'industrial', 'SMG': 'industrial',
    'SNDR': 'industrial', 'SON': 'industrial', 'SQM': 'industrial', 'SRCL': 'industrial', 'STLD': 'industrial', 'STNG': 'industrial',
    'STRL': 'industrial', 'SUMMIT': 'industrial', 'SWK': 'industrial', 'TBI': 'industrial', 'TER': 'industrial', 'TEX': 'industrial',
    'TNK': 'industrial', 'TPC': 'industrial', 'TREX': 'industrial', 'TROX': 'industrial', 'TRS': 'industrial', 'TT': 'industrial',
    'TTEK': 'industrial', 'UAL': 'industrial', 'UFPI': 'industrial', 'UNP': 'industrial', 'UPS': 'industrial', 'URI': 'industrial',
    'US': 'industrial', 'VMC': 'industrial', 'WCN': 'industrial', 'WERN': 'industrial', 'WM': 'industrial', 'WPM': 'industrial',
    'WSC': 'industrial', 'WSO': 'industrial', 'X': 'industrial', 'XPO': 'industrial', 'ZIM': 'industrial',
    # aero_defense
    'AIR': 'aero_defense', 'AJRD': 'aero_defense', 'AVAV': 'aero_defense', 'AXON': 'aero_defense', 'BA': 'aero_defense', 'BAH': 'aero_defense',
    'BWXT': 'aero_defense', 'CACI': 'aero_defense', 'CW': 'aero_defense', 'DCO': 'aero_defense', 'ERJ': 'aero_defense', 'GD': 'aero_defense',
    'HEI': 'aero_defense', 'HEI-A': 'aero_defense', 'HII': 'aero_defense', 'HWM': 'aero_defense', 'LDOS': 'aero_defense', 'LHX': 'aero_defense',
    'LMT': 'aero_defense', 'MOG-A': 'aero_defense', 'MRCY': 'aero_defense', 'NOC': 'aero_defense', 'NPK': 'aero_defense', 'RGR': 'aero_defense',
    'RKLB': 'aero_defense', 'RTX': 'aero_defense', 'SAIC': 'aero_defense', 'SPCE': 'aero_defense', 'SPR': 'aero_defense', 'SWBI': 'aero_defense',
    'TDG': 'aero_defense', 'TGI': 'aero_defense', 'VSTO': 'aero_defense',
    # ep
    'AESI': 'ep', 'APA': 'ep', 'AR': 'ep', 'AROC': 'ep', 'BATL': 'ep', 'BKR': 'ep',
    'BP': 'ep', 'CHK': 'ep', 'CHRD': 'ep', 'CIVI': 'ep', 'CLB': 'ep', 'CNQ': 'ep',
    'COP': 'ep', 'CPG': 'ep', 'CRGY': 'ep', 'CVE': 'ep', 'CVI': 'ep', 'CVX': 'ep',
    'DINO': 'ep', 'DK': 'ep', 'DO': 'ep', 'DVN': 'ep', 'E': 'ep', 'EC': 'ep',
    'EOG': 'ep', 'EQNR': 'ep', 'EQT': 'ep', 'ESTE': 'ep', 'FANG': 'ep', 'FTI': 'ep',
    'HAL': 'ep', 'HES': 'ep', 'HFC': 'ep', 'HP': 'ep', 'IMO': 'ep', 'LBRT': 'ep',
    'MEG': 'ep', 'MPC': 'ep', 'MRO': 'ep', 'MTDR': 'ep', 'NBR': 'ep', 'NE': 'ep',
    'NOG': 'ep', 'OIS': 'ep', 'OVV': 'ep', 'OXY': 'ep', 'PARR': 'ep', 'PBF': 'ep',
    'PBR': 'ep', 'PR': 'ep', 'PSX': 'ep', 'PTEN': 'ep', 'PUMP': 'ep', 'PXD': 'ep',
    'REI': 'ep', 'RIG': 'ep', 'ROCC': 'ep', 'RRC': 'ep', 'SHEL': 'ep', 'SLB': 'ep',
    'SM': 'ep', 'SU': 'ep', 'SWN': 'ep', 'TOU': 'ep', 'TTE': 'ep', 'USAC': 'ep',
    'VAALCO': 'ep', 'VAL': 'ep', 'VLO': 'ep', 'VTLE': 'ep', 'WDS': 'ep', 'WHD': 'ep',
    'XOM': 'ep', 'YPF': 'ep',
    # midstream
    'AM': 'midstream', 'CEQP': 'midstream', 'CLMT': 'midstream', 'CTRA': 'midstream', 'DCP': 'midstream', 'DLNG': 'midstream',
    'DTM': 'midstream', 'ENLC': 'midstream', 'EPD': 'midstream', 'ET': 'midstream', 'FLNG': 'midstream', 'GEL': 'midstream',
    'GLNG': 'midstream', 'GLP': 'midstream', 'HEP': 'midstream', 'HESM': 'midstream', 'KMI': 'midstream', 'KNTK': 'midstream',
    'LNG': 'midstream', 'MPLX': 'midstream', 'NFE': 'midstream', 'NS': 'midstream', 'OKE': 'midstream', 'PAA': 'midstream',
    'PAGP': 'midstream', 'SMLP': 'midstream', 'TRGP': 'midstream', 'WES': 'midstream', 'WMB': 'midstream',
    # utility
    'AEE': 'utility', 'AEP': 'utility', 'AES': 'utility', 'AGR': 'utility', 'ALE': 'utility', 'ARRY': 'utility',
    'ATO': 'utility', 'AVA': 'utility', 'AWK': 'utility', 'AY': 'utility', 'BE': 'utility', 'BKH': 'utility',
    'BLDP': 'utility', 'BLNK': 'utility', 'CEG': 'utility', 'CHPT': 'utility', 'CMS': 'utility', 'CNP': 'utility',
    'CWEN': 'utility', 'CWEN-A': 'utility', 'CWT': 'utility', 'D': 'utility', 'DTE': 'utility', 'DUK': 'utility',
    'ED': 'utility', 'EIX': 'utility', 'ENPH': 'utility', 'ES': 'utility', 'ETR': 'utility', 'EVGO': 'utility',
    'EVRG': 'utility', 'EXC': 'utility', 'FCEL': 'utility', 'FE': 'utility', 'FSLR': 'utility', 'IDA': 'utility',
    'LNT': 'utility', 'MAXN': 'utility', 'MGEE': 'utility', 'NEE': 'utility', 'NEP': 'utility', 'NFG': 'utility',
    'NI': 'utility', 'NOVA': 'utility', 'NWE': 'utility', 'OGE': 'utility', 'OGS': 'utility', 'ORA': 'utility',
    'OTTER': 'utility', 'OTTR': 'utility', 'PCG': 'utility', 'PLUG': 'utility', 'PNM': 'utility', 'PNW': 'utility',
    'POR': 'utility', 'PPL': 'utility', 'RNEW': 'utility', 'RUN': 'utility', 'SEDG': 'utility', 'SHLS': 'utility',
    'SJW': 'utility', 'SO': 'utility', 'SR': 'utility', 'SRE': 'utility', 'SWX': 'utility', 'UTL': 'utility',
    'VST': 'utility', 'WEC': 'utility', 'WTRG': 'utility', 'XEL': 'utility', 'YORW': 'utility',
    # telecom
    'ANGI': 'telecom', 'ASTS': 'telecom', 'ATUS': 'telecom', 'BMBL': 'telecom', 'CABO': 'telecom', 'CCI': 'telecom',
    'CHTR': 'telecom', 'CINE': 'telecom', 'CMCSA': 'telecom', 'CNK': 'telecom', 'CRTO': 'telecom', 'DLO': 'telecom',
    'DSP': 'telecom', 'FOX': 'telecom', 'FOXA': 'telecom', 'FYBR': 'telecom', 'GCI': 'telecom', 'GILT': 'telecom',
    'GSAT': 'telecom', 'GTN': 'telecom', 'IAC': 'telecom', 'IAS': 'telecom', 'IMAX': 'telecom', 'IPG': 'telecom',
    'LBRDA': 'telecom', 'LBRDK': 'telecom', 'LEE': 'telecom', 'LGF-A': 'telecom', 'LGF-B': 'telecom', 'LUMN': 'telecom',
    'MGNI': 'telecom', 'MNI': 'telecom', 'MSGE': 'telecom', 'MSGN': 'telecom', 'MSGS': 'telecom', 'MTCH': 'telecom',
    'NWS': 'telecom', 'NWSA': 'telecom', 'NXST': 'telecom', 'NYT': 'telecom', 'OMC': 'telecom', 'PARA': 'telecom',
    'PUBM': 'telecom', 'SATS': 'telecom', 'SBAC': 'telecom', 'SIRI': 'telecom', 'SSP': 'telecom', 'T': 'telecom',
    'TGNA': 'telecom', 'TMUS': 'telecom', 'TVE': 'telecom', 'USM': 'telecom', 'VZ': 'telecom', 'WBD': 'telecom',
    'WPP': 'telecom', 'ZD': 'telecom',
    # bdc
    'ARCC': 'bdc', 'BBDC': 'bdc', 'BCSF': 'bdc', 'BXSL': 'bdc', 'CCAP': 'bdc', 'CGBD': 'bdc',
    'CSWC': 'bdc', 'ECC': 'bdc', 'FDUS': 'bdc', 'FSK': 'bdc', 'GAIN': 'bdc', 'GBDC': 'bdc',
    'GLAD': 'bdc', 'GSBD': 'bdc', 'HRZN': 'bdc', 'HTGC': 'bdc', 'MAIN': 'bdc', 'MFIC': 'bdc',
